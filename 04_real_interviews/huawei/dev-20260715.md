...
layout: default
title: 华为国内研发岗 7.15
description: 华为 2026 国内研发岗笔试真题解析，含双指针水槽存水、回溯剪枝多载波选择、滚动数组最长公共子序列
eyebrow: 大厂真题 / 华为
...
$$
|T| - \operatorname{LCS}(T,S)
$$

**第三步：用滚动数组降低内存**

经典 LCS 二维 DP 需要 $O(|T||S|)$ 个整数，在 Python 中内存开销较大。每一行只依赖上一行与本行左侧，可以用一维数组 `dp` 滚动更新。
